...
from weimoo.pareto_reflecting_library.sequences.epsilon_avoiding_sequence import EpsilonAvoidingSequence
from weimoo.stopping_criteria.max_iterations_reached import MaxIterationsReached


class AvoidingWithWeightedNormToUtopia(MOOExpress):
    def __init__(self,
